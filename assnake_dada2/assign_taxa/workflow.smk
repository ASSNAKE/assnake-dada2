...
rule dada2_assign_taxa:
    input: '{fs_prefix}/{df}/dada2/{sample_set}/learn_errors__{err_params}/seqtab_nochim__{min_overlap}.rds'
    output: '{fs_prefix}/{df}/dada2/{sample_set}/learn_errors__{err_params}/taxa_{min_overlap}.rds'
    threads: 24
    conda: '../dada2.yaml'
