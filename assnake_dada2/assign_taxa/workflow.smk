...
class Breakpoint():
    def __init__(self, wc_str):
        self.wc_str == self.wc_str 
        return
...
rule dada2_assign_taxa:
    ...
    output: '{fs_prefix}/{df}/dada2/{sample_set}/learn_errors__{learn_errors_preset}/core_algo__{core_algo_preset}/merged__{merged_preset}/nonchim__{nonchim_preset}/taxa_{algo}__{db}__{preset}.rds'
    threads: 50
    conda: '../dada2.yaml'
